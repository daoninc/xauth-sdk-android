...
@Composable
fun RegisterVoiceScreen(onNavigateUp: () -> Unit, voiceController: VoiceController) {
    ...
    Scaffold(topBar = { AppTopAppBar(title = "Voice Registration") }) { paddingValues ->
